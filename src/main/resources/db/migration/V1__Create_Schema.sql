...
ALTER TABLE plateforme
    ADD CONSTRAINT uc_plateforme_adresse UNIQUE (adresse_id);

ALTER TABLE utilisateur
    ADD CONSTRAINT uc_utilisateur_adresse UNIQUE (adresse_id);

ALTER TABLE utilisateur
    ADD CONSTRAINT uc_utilisateur_email UNIQUE (email);

ALTER TABLE utilisateur
    ADD CONSTRAINT uc_utilisateur_plateforme UNIQUE (plateforme_id);
...
ALTER TABLE plateforme
    ADD CONSTRAINT FK_PLATEFORME_ON_ADRESSE FOREIGN KEY (adresse_id) REFERENCES adresse (id);
