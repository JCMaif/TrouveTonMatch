...
ALTER TABLE parrain
    ADD CONSTRAINT FK_PARRAIN_ON_PLATEFORME FOREIGN KEY (plateforme_id) REFERENCES plateforme (id);

ALTER TABLE porteur
    ADD CONSTRAINT FK_PORTEUR_ON_ID FOREIGN KEY (id) REFERENCES utilisateur (id);
ALTER TABLE porteur
    ADD CONSTRAINT FK_PORTEUR_ON_PLATEFORME FOREIGN KEY (plateforme_id) REFERENCES plateforme (id);
ALTER TABLE porteur
    ADD CONSTRAINT FK_PORTEUR_ON_PROJET FOREIGN KEY (projet_id) REFERENCES projet (id);
